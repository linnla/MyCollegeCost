...
@interface CollegeViewController : UIViewController <UIActionSheetDelegate>
...
@property (nonatomic, retain) NSMutableDictionary *costSections;
@property (nonatomic, retain) NSMutableArray *academicArray;
@property (nonatomic, retain) NSMutableArray *searchArray;
@property (nonatomic, retain) NSMutableArray *costArray;
@property (nonatomic, retain) NSMutableArray *forbesArray;
@property (nonatomic, retain) NSMutableArray *usNewsArray;
